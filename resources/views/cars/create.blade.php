    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('cars.index') }}"> {{__('messages.back')}}</a>
            </div>
        </div>
    </div>
    @if(session('status'))
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="number" class="form-control" placeholder="A 007 AA | 197">
                    @error('number')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" onchange="ChangeText()" id="is_paid" name="is_paid" class="form-control">
